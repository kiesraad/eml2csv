# eml2csv
Python code for converting an [EML_NL](https://github.com/kiesraad/EML_NL) file to a csv file (osv4-3) format.
...
## How to use
`lib.py` exports a function `create_osv_csv` which takes three parameters:
